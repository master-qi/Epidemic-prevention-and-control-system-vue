<template>
  <div class="mod-role">
    ...
    <el-table
      ...
      <el-table-column prop="title" header-align="center"  align="center" label="公告标题" width="260"></el-table-column>
      <el-table-column prop="content" header-align="center"  align="center" label="公告内容" ></el-table-column>
      <el-table-column prop="createBy" header-align="center"  align="center" label="发布人" width="80"></el-table-column>
      <el-table-column prop="createTime" header-align="center"  align="center" label="发布时间" width="160"></el-table-column>
