<template>
  <div class="mod-role">
    ...
    <el-table
      ...
      <el-table-column prop="place" header-align="center"  align="center" label="出行地点"></el-table-column>
<!--      <el-table-column prop="cxTime" header-align="center"  align="center" label="出行时间"></el-table-column>-->
...
<script>
  import AddOrUpdate from './thm-add-or-update'
    ...
    methods: {
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/sys/thm/delete'),
            method: 'post',
